class TransactionDrafter
  def draft_transaction(user:, transaction:, attributes:, tag_ids:)
    ...
    Result.new(transaction: transaction, tags: tags)
  end
  ...
  class Result
    attr_reader :transaction, :tags

    def initialize(transaction:, tags:)
