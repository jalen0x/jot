...
| Transaction statistics, amount summaries, and account balance trends | Phase 2 | `LedgerStatistics`, `TransactionAmountSummary`, `LedgerTrends`, `AccountBalanceTrends` |
